...
* [x] タスクトレイ常駐
* [x] 自動起動
* [x] CPU / RAM カードのアコーディオン化
  * デフォルト表示は現状のまま、展開時にそれぞれ使用率 Top 3 のプロセスを表示
* [x] UI 編集モード中にカードをドラッグ移動している間のアニメーション追加
  * カードを掴めていること、移動中であることを分かりやすくする
* [x] 各種ショートカットボタンの実装
  * Footer のショートカット画面から URL / ファイル / アプリを起動
